...
+
Auf der Seite „Ressourcen“ gibt das image:../media/not_supported_icon.png["Unterstütztes Symbol"] Symbol an, dass sich die Datenbank auf Storage anderer Anbieter befindet.
